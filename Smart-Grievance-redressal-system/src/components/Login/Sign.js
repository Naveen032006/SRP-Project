...
import { Authuse } from "../../context/Authcontext"; // ✅ no props needed

const Sign = () => {
  const { setLogin } = Authuse(); // ✅ from context
  ...
  return (
    <form className="container" onSubmit={handlesubmit} style={{ backgroundColor: Color.primary }}>
      ...
      <br />
      <button id="submit" type="submit" style={{ color: "#ffffffff", backgroundColor: "#4dd395ff" }}>
        Submit
      </button>
    </form>
  );
