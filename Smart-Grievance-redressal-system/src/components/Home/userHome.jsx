...
function UserHome() {
  ...
  const Sidebar = () => {
    const { section, setSection, setNavOpen } = useUI();
    const items = [
    ...
    return (
      <aside style={{
        ...
        <div style={{ padding: "6px 6px 12px 6px" }}>
          <div style={{ fontWeight: 700, color: Color.foreground, marginBottom: 10 }}>UrbanEye</div>
        </div>
  ...
  return (
    <div className="UserBody">
      ...
      >
        ...
        {section === "subcomplain" && <div className="content1"><SubComplain /></div>}
        {section === "mycomplain" && <div className="content2"><Mycomplain /></div>}
